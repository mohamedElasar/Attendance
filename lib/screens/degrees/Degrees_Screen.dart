          ...
          children: [
            ...
            Expanded(
              child: ListView.separated(
                  ...
                  itemBuilder: (context, item) => buildTable(),
    ...
    return Column(
      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  defaultFormField(
                                    ...
                                    prefix: Icons.fact_check_rounded,
                                  ),
                                  SizedBox(
                                    height: 15,
                                  ),
        ...
        Container(
          ...
          child: Row(
            children: [
              buildCell(size.width * .2, 'الحصه', bkground: kbuttonColor3),
              buildCell(size.width * .2, 'التاريخ',
                  bkground: kbuttonColor3),
              buildCell(size.width * .2, 'الحضور', bkground: kbuttonColor3),
              buildCell(size.width * .2, 'الدرجه', bkground: kbuttonColor3),
            ],
          ),
        ),
        Container(
          ...
          child: Row(
            children: [
              ...
              buildCell(size.width * .2, '14/2', bkground: Colors.white),
              buildicon(size.width * .2, 'ok', bkground: Colors.white),
              buildCell(size.width * .2, '80', bkground: Colors.white),
            ],
          ),
        ),
